...
EXPECTED_IMPORTED_TRANSACTIONS: list[Transaction] = [
    ...
    Transaction(
        ...
        11,
        False,
        datetime.strptime("2023:09:04 12:00:09", receipt_date_format),
        None,
        "IMG_5796.png",
        35.87290277777778,
        -78.62357222222222,
    ...
    Transaction(
        None,
        "Subs with Sara before heading back to state after labor day weekend",
        12,
        False,
        datetime.strptime("2023:09:04 12:09:19", receipt_date_format),
        None,
        "IMG_5797.png",
        35.87278611111111,
        -78.62358055555555,
    ...
    Transaction(
        None,
        "Groceries for parents, photo accidentally taken at home",
        10,
        False,
        datetime.strptime("2024:05:05 18:43:50", receipt_date_format),
        None,
        "IMG_6157.png",
        35.914294444444444,
        -78.62241388888889,
    ...
    Transaction(
        None,
        "Wendys dinner on the way to concert",
        0,
        False,
        datetime.strptime("2024:05:14 18:28:24", receipt_date_format),
        None,
        "IMG_6175.png",
        35.86669166666667,
        -80.07146388888889,
